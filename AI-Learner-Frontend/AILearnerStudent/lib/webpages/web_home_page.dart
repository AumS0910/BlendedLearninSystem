  ...
  Future<void> getDataFromAPI() async {
    try {
      final response = await http.get(
        Uri.parse('https://al-learner-backend.onrender.com/course'),
        headers: {
          'Access-Control-Allow-Origin': '*', // Add your custom header here
        },
      );
      ...
      throw e; // Rethrow the error to handle it in the caller method
    }
  }
